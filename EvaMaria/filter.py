...
@Client.on_message(
    commandpro(["divyesh", "divyeshh"]) & filters.group & ~filters.edited
)
async def start(client: Client, message: Message):
    await message.reply_video(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("ƬᕼΞ ĽΞᎶξŊƊ...🖤", url=f"https://t.me/zaynxop")]]
        ),
    )
...
async def start(client: Client, message: Message):
    await message.reply_video(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("ᴊᴏɪɴ ɴᴏᴡ ", url=f"https://t.me/mojilagujrati")]]
        ),
    )
